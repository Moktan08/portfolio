<template>
  <header class="sticky top-0 z-50 backdrop-blur-md bg-[#0b1120]/80 border-b border-slate-800/60">
    <div class="max-w-5xl mx-auto px-6 h-20 flex items-center justify-between">
      <a href="#" class="text-xl font-bold tracking-wider text-white">
        ROMI<span class="text-sky-500">.LAMA</span>
      </a>
